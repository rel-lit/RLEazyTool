...
def print_help() -> None:
    ...
    print("  this ll N  : 列出第 N 层文件夹（需已开启 this 模式）")
    print("  this ll all: 列出整棵目录树可配置节点")
    print("  this a <路径>: 添加细则包含（多级路径）")
    print("  this s <路径>: 排除子路径（不可排除顶层文件夹）")
    ...
    print("")
    print("  exc                         : 启用上次合并成功的排除组")
    print("  exc u <组名> | exc off      : 启用 / 关闭排除组")
